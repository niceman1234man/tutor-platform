        ...
        <div className="container mx-auto px-6 flex flex-col md:flex-row items-center justify-between">
          ...
          <div className="md:w-1/2">
            ...
            <p className="mt-6 text-gray-600 text-lg">
              Explore expert-led courses and build real-world skills for your
              future.
            </p>
            ...
            <div className="flex gap-6 mt-10 text-gray-600">
              <span className="flex items-center gap-2">
                <FaGraduationCap className="text-teal-700" /> Expert Instructors
              </span>
              <span className="flex items-center gap-2">
                <FaBook className="text-teal-700" /> Flexible Learning
              </span>
              <span className="flex items-center gap-2">
                <FaCertificate className="text-teal-700" /> Certifications
              </span>
            </div>
          </div>
          ...
          {loadingExams ? (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 mb-8">
              {exams.slice(0, 3).map((ex, idx) => (
                <div
                  key={ex._id || idx}
                  className={`bg-white shadow-lg rounded-xl p-6 flex flex-col items-start border-t-4 ${idx === 0 ? "border-teal-500" : idx === 1 ? "border-indigo-500" : "border-pink-500"}`}
                >
                  <div className="text-xl font-semibold text-indigo-700 mb-1 truncate">
                    {ex.title}
                  </div>
                  ...
                  <div className="text-xs text-gray-400 mb-4">
                    Duration: {ex.duration ? `${ex.duration} min` : "—"}
                  </div>
                  <button
        ...
        <div className="container mx-auto px-6 flex flex-col md:flex-row items-center gap-10">
          ...
          <div className="md:w-1/2">
            <h2 className="text-3xl font-bold mb-8">
              <span className="underline">Why</span> Choose Skill Nest?
            </h2>
            ...
            <div className="space-y-6">
              <div>
                <h4 className="font-semibold text-lg">
                  {" "}
                  <FaPersonBooth className="text-teal-700 inline mr-2" /> Expert
                  Mentors
                </h4>
              ...
              <div>
                <h4 className="font-semibold text-lg">
                  {" "}
                  <FaProjectDiagram className="text-teal-700 inline mr-2" />{" "}
                  Hands-on Projects
                </h4>
                <p className="text-gray-700">
              ...
              <div>
                <h4 className="font-semibold text-lg">
                  {" "}
                  <FaCalculator className="text-teal-700 inline mr-2" />{" "}
                  Flexible Learning
                </h4>
                <p className="text-gray-700">
        ...
        <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="mt-4 text-gray-400">
              Learn. Grow. Succeed with expert-led courses designed for your
              future.
            </p>
          </div>
